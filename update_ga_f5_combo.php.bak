<?php
	...
	{ 
		...
		$query_d = "SELECT * FROM ga_f5_2_42 ";
		#$query_d .= "WHERE nums_count <=  '2' ";
		$query_d .= "WHERE date >= '2015-10-01' ";
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Update 2_42 - $game_name</H2>\n");
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Update 3_42 - $game_name</H2>\n");
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Update 4_42 - $game_name</H2>\n");
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Rebuild 3_42 - $game_name</H2>\n");
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Rebuild 2_42 - $game_name</H2>\n");
