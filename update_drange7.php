<?php
	...
	{ 
		...
		$query4 = "SELECT * FROM ga_f5_draws_draw7 ";
		...
		if (!$num_rows4)
		{
			...
			$query4 = "INSERT INTO ga_f5_draws_draw7 ";
			$query4 .= "VALUES('0', ";
			$query4 .= "'$date', ";
			$query4 .= "'$d1', ";
			$query4 .= "'$d2', ";
	...
	print("<HTML>\n");
	print("<HEAD>\n");
	print("<TITLE>Lotto Update Drange7 - $game_name - Rank Limit</TITLE>\n");
	print("</HEAD>\n");
	...
	while ($row5 = mysqli_fetch_array($mysqli_result5))
	{
		...
		lot_update_drange7 ($row5[0], $draw); ### 201223
	}
