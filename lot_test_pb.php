<?php
	...
	if ($game == 1)
	{
		...
		require ("includes_pb/pb_print_wheel_sum_table_eo2.php");
		require ("includes_pb/pb_print_wheel_sum_table_eo3.php");
		require ("includes_pb/pb_print_wheel_sum_table_eo4.php");
		require ("includes_pb/pb_print_wheel_sum_table_eo5.php");
		require ("includes_pb/pb_print_wheel_sum_table_eo6.php");
		require ("includes_pb/pb_print_wheel_sum_table_eo7.php");
		#require ("includes_pb/pb_print_wheel_sum_table_eo8.php");
		#require ("includes_pb/pb_print_wheel_sum_table_eo9.php");
		#require ("includes_pb/pb_print_wheel_sum_table_eo10.php");
	} elseif ($game == 2) {
		...
		while($row_draw = mysqli_fetch_array($mysqli_result))
		{
			...
			if ($num_rows_combo)
			{
				...
				for ($c = 1; $c <= 10; $c++)
				{
					...
					$query2 = "SELECT DISTINCT * FROM pb_2_69 ";
					$query2 .= "WHERE d1 = $d1 ";
					$query2 .= "  AND d2 = $d2 ";
				...
				for ($c = 1; $c <= 10; $c++)
				{
					...
					$query3 = "SELECT DISTINCT * FROM pb_3_69 ";
					$query3 .= "WHERE d1 = $d1 ";
					$query3 .= "  AND d2 = $d2 ";
					$query3 .= "  AND d3 = $d3 ";
				...
				for ($c = 1; $c <= 5; $c++)
				{
					...
					$query4 = "SELECT DISTINCT date, d1, d2, d3, d4 FROM pb_4_69 ";
					$query4 .= "WHERE d1 = $d1 ";
					$query4 .= "  AND d2 = $d2 ";
					$query4 .= "  AND d3 = $d3 ";
					$query4 .= "  AND d4 = $d4 ";
	...
	{	
		...
		if ($game == 1)
		{ 
			#pb_print_wheel_sum_table_eo5($limit=10000);
			#pb_print_wheel_sum_table_eo($limit=10000); 
			#pb_print_wheel_sum_table_eo3($limit=10000); #1350
			#die();
			echo "eo2</br>";
			pb_print_wheel_sum_table_eo2($limit=1575); #1575
			echo "eo3</br>";
			pb_print_wheel_sum_table_eo3($limit=1575); #1350
			echo "eo4</br>";
			pb_print_wheel_sum_table_eo4($limit=1575); #1350 
			echo "eo5</br>";
			pb_print_wheel_sum_table_eo5($limit=1575); #1350 
			echo "eo6</br>";
			pb_print_wheel_sum_table_eo6($limit=1575); #1350 
			echo "eo7</br>";
			pb_print_wheel_sum_table_eo7($limit=1575); 
		} elseif ($game == 2) {
			echo "game = $game<br>";
	...
	{	
		...
		if ($game == 1)
		{
			pb_print_wheel_sum_table_eo7($limit=10000);
		} elseif ($game == 7) {
