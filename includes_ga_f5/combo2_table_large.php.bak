	...
	for ($x = 1; $x <= $balls; $x++)
	{
		for ($y = 1; $y <= $balls; $y++)
		{
			if ($x <> $y)
			{
				...
				// 1
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix));
				...
				// 7
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*7)));
				...
				// 14
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*14)));
				...
				// 30
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*30)));
				...
				// 90
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*90)));
				...
				// 180
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*180)));
				...
				// year1
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*365)));
				...
				// year2
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*(365*2))));
				...
				// year3
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*(365*3))));
				...
				// year4
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*(365*4))));
				...
				// year5
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*(365*5))));
				...
				// year6
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*(365*6))));
				...
				// year7
				$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*(365*7))));
				...
				{
					$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*(365*8))));
				...
				{
					$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*(365*9))));
				...
				{
					$temp_date = strftime("%Y-%m-%d", ($last_draw_unix-(86400*(365*10))));
