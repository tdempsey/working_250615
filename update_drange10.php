<?php
	...
	function lot_update_drange10 ($date, $draw)
	{ 
		global $debug;
	
		require ("includes/mysqli.php");

		$query4 = "SELECT * FROM ga_f5_draws_draw10 ";
		...
		if (!$num_rows4)
		{
			...
			$range1 = intval(42/10);
			$range2 = intval((42/10)*2);
			$range3 = intval((42/10)*3);
			$range4 = intval((42/10)*4);
			$range5 = intval((42/10)*5);
			$range6 = intval((42/10)*6);
			$range7 = intval((42/10)*7);
			$range8 = intval((42/10)*8);
			$range9 = intval((42/10)*9);
			...
			$query4 = "INSERT INTO ga_f5_draws_draw10 ";
			$query4 .= "VALUES('0', ";
			$query4 .= "'$date', ";
			$query4 .= "'$d1', ";
			$query4 .= "'$d2', ";
	...
	print("<HTML>\n");
	print("<HEAD>\n");
	print("<TITLE>Lotto Update Drange10 - $game_name - Rank Limit</TITLE>\n");
	print("</HEAD>\n");
	...
	while ($row5 = mysqli_fetch_array($mysqli_result5))
	{
		...
		lot_update_drange10 ($row5[0], $draw); ### 201223
	}
