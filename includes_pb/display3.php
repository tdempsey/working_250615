<?php
	...
	{ 
		...
		if (1)
		{
			...
			require ("includes_pb/display3nav.incl");
			...
			{	
				...
				if ($row[9] == 0)
				{
					...
					require ("includes_pb/update_even_odd3.incl");
			...
			#
			require ("includes_pb/draw_count_table_3.incl"); #fix 1911
			##############################################################################
			...
			if ($limit > 105)
			{
				require ("includes_pb/unsorted_table_large_3.incl");
				#require ("includes/unsorted_table_1510.incl");
			} elseif ($limit == 100) {
				require ("includes_pb/unsorted_table_100_3.incl");
			} else {
				require ("includes_pb/unsorted_table_3.incl");
			}
			...
			if ($limit > 105 )
			{
				require ("includes_pb/sorted_table_large_3.incl");
			} elseif ($limit == 100) {
				require ("includes_pb/sorted_table_100_3.incl");
			} else {
				require ("includes_pb/sorted_table_3.incl");
			}
