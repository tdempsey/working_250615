<?php
	...
	{ 
		...
		for ($combin = 1; $combin <= 5; $combin++)
		{
			...
			if ($limit > 105 )
			{
				require ("includes_mm/unsorted_table_4_all.incl");
				require ("includes_mm/sorted_table_4_all.incl");
			} elseif ($limit == 100) {
				require ("includes_mm/unsorted_table_4_all.incl");
				require ("includes_mm/sorted_table_4_all.incl");
			} else {
			...
			if ($limit > 105 )
			{
				require ("includes_mm/sorted_table_large_4_all.incl");
			} elseif ($limit == 100) {
				require ("includes_mm/sorted_table_100_4_all.incl");
			} else {
				require ("includes_mm/sorted_table_4_all.incl");
			}
			*/
