<?php
	...
	print("<HTML>\n");
	print("<HEAD>\n");
	print("<TITLE>Update fl_draw_pair_sum</TITLE>\n");
	print("</HEAD>\n");
	...
	$query3 = "DROP TABLE IF EXISTS fl_draw_pair_sum ";
	
	$mysqli_result3 = mysqli_query($mysqli_link, $query3) or die (mysqli_error($mysqli_link));

	$query4 = "CREATE TABLE fl_draw_pair_sum ( ";
	...
	print_pair_sum_grid_6(104);
	print_pair_sum_table_6(104);
	...
	// ----------------------------------------------------------------------------------
	function print_pair_sum_grid_6($limit)
	{
		global $draw_table_name, $balls, $balls_drawn, $draw_prefix; 
	...
	// ----------------------------------------------------------------------------------
	function print_pair_sum_table_6($limit)
	{
		global $debug, $draw_table_name, $draw_prefix, $balls, $balls_drawn, $game; 
