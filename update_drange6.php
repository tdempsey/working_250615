<?php
	...
	function lot_update_drange6 ($date, $draw)
	{ 
		global $debug;
	
		require ("includes/mysqli.php");

		$query4 = "SELECT * FROM ga_f5_draws_draw6 ";
		...
		if (!$num_rows4)
		{
			...
			$query4 = "INSERT INTO ga_f5_draws_draw6 ";
			$query4 .= "VALUES('0', ";
			$query4 .= "'$date', ";
			$query4 .= "'$d1', ";
			$query4 .= "'$d2', ";
	...
	print("<HTML>\n");
	print("<HEAD>\n");
	print("<TITLE>Lotto Update Drange6 - $game_name - Rank Limit</TITLE>\n");
	print("</HEAD>\n");
	...
	while ($row5 = mysqli_fetch_array($mysqli_result5))
	{
		...
		lot_update_drange6 ($row5[0], $draw); ### 201223
	}
