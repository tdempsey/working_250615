<?php
	...
	{ 
		global $debug, $game, $game_name, $balls, $balls_drawn, $mefl_balls, $draw_table_name, $draw_prefix, $game_includes;
		...
		$query_d = "SELECT * FROM fl_f5_4_36 ";
		...
		{	
			$query_combo = "SELECT * FROM combo_5_36 ";
	...
	{ 
		...
		$curr_date = date("Y-m-d");
		$curr_date = '2014-01-25';

		$query_d = "SELECT * FROM combo_5_36 ";
		$query_d .= "WHERE last_updated < '2014-01-25' ";
		#$query_d .= "AND b1 = 11 ";
		$query_d .= "AND b1 <= 12 ";
	...
	{ 
		...
		$query_d = "SELECT * FROM fl_f5_3_36 ";
		#$query_d .= "WHERE nums_count <=  '2' ";
		$query_d .= "WHERE date >= '$update_date' ";
		$query_d .= "ORDER BY date DESC ";
	...
	{ 
		...
		$query_d = "SELECT * FROM fl_f5_2_36 ";
		#$query_d .= "WHERE nums_count <=  '2' ";
		$query_d .= "WHERE date >= '$update_date' ";
		$query_d .= "ORDER BY date DESC ";
	...
	{ 
		...
		$query_d = "SELECT * FROM fl_f5_draws ";
		$query_d .= "WHERE date >= '$update_date' ";
		$query_d .= "ORDER BY date DESC ";
		...
		while($row = mysqli_fetch_array($mysqli_result_d))
		{	
			$query_combo = "SELECT * FROM fl_f5_draws ";
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Update 2_36 - $game_name</H2>\n");
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Update 3_36 - $game_name</H2>\n");
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Update 4_36 - $game_name</H2>\n");
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Rebuild 3_36 - $game_name</H2>\n");
	...
	{ 
		...
		print("<H2>Lotto Combo 5 Rebuild 2_36 - $game_name</H2>\n");
